...
// configuration step. It creates a namespace called `randomCppProject`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", randomCppProject::cmake::project_name, randomCppProject::cmake::project_version) };
    ...
    if (show_version) {
      fmt::print("{}\n", randomCppProject::cmake::project_version);
      return EXIT_SUCCESS;
    }
